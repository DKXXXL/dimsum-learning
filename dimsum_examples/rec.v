...
Proof.
  ...
  8: { apply Hcall; [auto|]. apply Forall_true => ?. by apply: FIX. }
  all: auto.
Qed.
...
Fixpoint is_static_expr (allow_loc : bool) (e : expr) : bool :=
  ...
  | Call f args => is_static_expr allow_loc f && forallb (is_static_expr allow_loc) args  | AllocA _ e => allow_loc && is_static_expr allow_loc e
...
Lemma static_expr_ind (P : static_expr → Prop) :
  ...
  (∀ (f : static_expr) (args : list static_expr), P f → Forall P args → P (SCall f args)) →  ∀ (e : static_expr), P e.
Proof.
